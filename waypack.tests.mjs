...
// ---------- 47. Lazy images and achievements ----------
{
  ...
  check('20 achievements, none earned on a fresh save, each with badge art from the pool or a generated emblem', GMS.ACHIEVEMENTS.length === 20 && a0.every(a => !a.done) && a0.every(a => typeof GMS.achievementIcon(a) === 'string'));
